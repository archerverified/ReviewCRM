...
// Backwards-compatible SimpleSelect component
...
const SimpleSelect = React.forwardRef<HTMLButtonElement, SimpleSelectProps>(
  ({ label, value, onChange, options = [], placeholder = "Select...", className, allowCustomFields, onAddCustomField }, ref) => {
        ...
        {!showCustomInput ? (
          ...
          <div className="flex gap-2">
            ...
            <button
              type="button"
              onClick={() => {
                if (customFieldValue.trim() && onAddCustomField) {
                  onAddCustomField(customFieldValue.trim())
                }
                setCustomFieldValue("")
